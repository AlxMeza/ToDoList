...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <p className='text-white text-2xl font-semibold self-center md:block hidden sm:hidden'>LexCode</p>
                            </div>
                        </div>
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ml-6">
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link href={route('logout')} method="post" as="button" id='logoutBtn' className='block'>
                                            Log Out
                                        </Dropdown.Link>
                                    </Dropdown.Content>
                                </Dropdown>
            ...
            <main className='bg-white mb-10'>{children}</main>
        </div>
    );
}
